...
export default class WithdrawCreate extends React.Component {
    constructor (props){
        super(props);
        this.state ={
            type: '',
    ...
    handleSubmit(event) {
        ...
        Api.post(`/accounts/${this.props.match.params.id}/withdraws`, withdraw).then( () => {
            this.setState({message: "Withdraw made successfully!"});
        }).catch( (err) => {
    ...
    render(){
        return (
            <Card className="mt-4 mx-auto text-center" style={{maxWidth:"500px"}}>
                <h5 className="card-header">Please make a withdraw!</h5>
                <div className="card-body">
                    <form onSubmit={this.handleSubmit}>
                        ...
                        <div className=" text-center">
                            <button className=" btn btn-primary mr-1" type={"submit"} value={"Submit"}>Make Withdraw</button>
